...
func TestHandlerWithStage(t *testing.T) {
	controller := gomock.NewController(t)
	defer controller.Finish()
...
func TestHandlerWithStage_Failing(t *testing.T) {
	...
	c.URLParams.Add("owner", "octocat")
	c.URLParams.Add("name", "hello-world")
	c.URLParams.Add("stage", "failure-stage")
...
func TestHandlerWithStage_Running(t *testing.T) {
	...
	c.URLParams.Add("owner", "octocat")
	c.URLParams.Add("name", "hello-world")
	c.URLParams.Add("stage", "running-stage")
...
func TestHandlerWithStage_Error(t *testing.T) {
	...
	c.URLParams.Add("owner", "octocat")
	c.URLParams.Add("name", "hello-world")
	c.URLParams.Add("stage", "error-stage")
