...
func initSystem(ctx context.Context, config *types.Config) (*server.System, error) {
	...
	cargoProxy := cargo2.ProxyProvider(upstreamProxyConfigRepository, registryRepository, imageRepository, artifactRepository, fileManager, transactor, provider, spaceFinder, secretService)
