...
func (s *stepStore) List(ctx context.Context, id int64) ([]*types.Step, error) {
	var out []*types.Step
...
func (s *stepStore) Find(ctx context.Context, id int64) (*types.Step, error) {
	out := &types.Step{ID: id}
	err := s.db.View(func(queryer db.Queryer, binder db.Binder) error {
		params := toParams(out)
...
func (s *stepStore) FindNumber(ctx context.Context, id int64, number int) (*types.Step, error) {
	out := &types.Step{StageID: id, Number: number}
	err := s.db.View(func(queryer db.Queryer, binder db.Binder) error {
		params := toParams(out)
...
func (s *stepStore) createPostgres(ctx context.Context, step *types.Step) error {
	step.Version = 1
	return s.db.Lock(func(execer db.Execer, binder db.Binder) error {
		params := toParams(step)
...
func (s *stepStore) Update(ctx context.Context, step *types.Step) error {
