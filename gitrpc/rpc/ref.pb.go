...
var file_ref_proto_rawDesc = []byte{
	...
	0x65, 0x52, 0x65, 0x66, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x32, 0xdb, 0x03, 0x0a,
	...
	,
...
var file_ref_proto_goTypes = []interface{}{
	...
	(*GetBranchRequest)(nil),              // 4: rpc.GetBranchRequest
	(*GetBranchResponse)(nil),             // 5: rpc.GetBranchResponse
	(*DeleteBranchRequest)(nil),           // 6: rpc.DeleteBranchRequest
	(*DeleteBranchResponse)(nil),          // 7: rpc.DeleteBranchResponse
	(*ListBranchesRequest)(nil),           // 8: rpc.ListBranchesRequest
	(*ListBranchesResponse)(nil),          // 9: rpc.ListBranchesResponse
	(*Branch)(nil),                        // 10: rpc.Branch
	(*ListCommitTagsRequest)(nil),         // 11: rpc.ListCommitTagsRequest
	(*ListCommitTagsResponse)(nil),        // 12: rpc.ListCommitTagsResponse
	(*CommitTag)(nil),                     // 13: rpc.CommitTag
	(*GetRefRequest)(nil),                 // 14: rpc.GetRefRequest
	(*GetRefResponse)(nil),                // 15: rpc.GetRefResponse
	(*UpdateRefRequest)(nil),              // 16: rpc.UpdateRefRequest
	(*UpdateRefResponse)(nil),             // 17: rpc.UpdateRefResponse
	(*WriteRequest)(nil),                  // 18: rpc.WriteRequest
	(*ReadRequest)(nil),                   // 19: rpc.ReadRequest
	(SortOrder)(0),                        // 20: rpc.SortOrder
	(*Commit)(nil),                        // 21: rpc.Commit
	(*Signature)(nil),                     // 22: rpc.Signature
	(RefType)(0),                          // 23: rpc.RefType
}
var file_ref_proto_depIdxs = []int32{
	18, // 0: rpc.CreateBranchRequest.base:type_name -> rpc.WriteRequest
	10, // 1: rpc.CreateBranchResponse.branch:type_name -> rpc.Branch
	19, // 2: rpc.GetBranchRequest.base:type_name -> rpc.ReadRequest
	10, // 3: rpc.GetBranchResponse.branch:type_name -> rpc.Branch
	18, // 4: rpc.DeleteBranchRequest.base:type_name -> rpc.WriteRequest
	19, // 5: rpc.ListBranchesRequest.base:type_name -> rpc.ReadRequest
	0,  // 6: rpc.ListBranchesRequest.sort:type_name -> rpc.ListBranchesRequest.SortOption
	20, // 7: rpc.ListBranchesRequest.order:type_name -> rpc.SortOrder
	10, // 8: rpc.ListBranchesResponse.branch:type_name -> rpc.Branch
	21, // 9: rpc.Branch.commit:type_name -> rpc.Commit
	19, // 10: rpc.ListCommitTagsRequest.base:type_name -> rpc.ReadRequest
	1,  // 11: rpc.ListCommitTagsRequest.sort:type_name -> rpc.ListCommitTagsRequest.SortOption
	20, // 12: rpc.ListCommitTagsRequest.order:type_name -> rpc.SortOrder
	13, // 13: rpc.ListCommitTagsResponse.tag:type_name -> rpc.CommitTag
	22, // 14: rpc.CommitTag.tagger:type_name -> rpc.Signature
	21, // 15: rpc.CommitTag.commit:type_name -> rpc.Commit
	19, // 16: rpc.GetRefRequest.base:type_name -> rpc.ReadRequest
	23, // 17: rpc.GetRefRequest.ref_type:type_name -> rpc.RefType
	18, // 18: rpc.UpdateRefRequest.base:type_name -> rpc.WriteRequest
	23, // 19: rpc.UpdateRefRequest.ref_type:type_name -> rpc.RefType
	2,  // 20: rpc.ReferenceService.CreateBranch:input_type -> rpc.CreateBranchRequest
	4,  // 21: rpc.ReferenceService.GetBranch:input_type -> rpc.GetBranchRequest
	6,  // 22: rpc.ReferenceService.DeleteBranch:input_type -> rpc.DeleteBranchRequest
	8,  // 23: rpc.ReferenceService.ListBranches:input_type -> rpc.ListBranchesRequest
	11, // 24: rpc.ReferenceService.ListCommitTags:input_type -> rpc.ListCommitTagsRequest
	14, // 25: rpc.ReferenceService.GetRef:input_type -> rpc.GetRefRequest
	16, // 26: rpc.ReferenceService.UpdateRef:input_type -> rpc.UpdateRefRequest
	3,  // 27: rpc.ReferenceService.CreateBranch:output_type -> rpc.CreateBranchResponse
	5,  // 28: rpc.ReferenceService.GetBranch:output_type -> rpc.GetBranchResponse
	7,  // 29: rpc.ReferenceService.DeleteBranch:output_type -> rpc.DeleteBranchResponse
	9,  // 30: rpc.ReferenceService.ListBranches:output_type -> rpc.ListBranchesResponse
	12, // 31: rpc.ReferenceService.ListCommitTags:output_type -> rpc.ListCommitTagsResponse
	15, // 32: rpc.ReferenceService.GetRef:output_type -> rpc.GetRefResponse
	17, // 33: rpc.ReferenceService.UpdateRef:output_type -> rpc.UpdateRefResponse
