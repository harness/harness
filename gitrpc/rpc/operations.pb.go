...
var file_operations_proto_depIdxs = []int32{
	...
	3, // 5: rpc.CommitFilesRequest.action:type_name -> rpc.CommitFilesAction
	4, // 6: rpc.CommitFilesService.CommitFiles:input_type -> rpc.CommitFilesRequest
	5, // 7: rpc.CommitFilesService.CommitFiles:output_type -> rpc.CommitFilesResponse
