...
var file_repo_proto_rawDesc = []byte{
	...
	0x6f, 0x6d, 0x6d, 0x69, 0x74, 0x10, 0x04, 0x32, 0xa6, 0x06, 0x0a, 0x11, 0x52, 0x65, 0x70, 0x6f,
	...
	,
...
var file_repo_proto_goTypes = []interface{}{
	...
	(*SyncRepositoryRequest)(nil),         // 27: rpc.SyncRepositoryRequest
	(*SyncRepositoryResponse)(nil),        // 28: rpc.SyncRepositoryResponse
	(*MergeBaseRequest)(nil),              // 29: rpc.MergeBaseRequest
	(*MergeBaseResponse)(nil),             // 30: rpc.MergeBaseResponse
	(*FileUpload)(nil),                    // 31: rpc.FileUpload
	(*WriteRequest)(nil),                  // 32: rpc.WriteRequest
	(*Identity)(nil),                      // 33: rpc.Identity
	(*ReadRequest)(nil),                   // 34: rpc.ReadRequest
	(*Commit)(nil),                        // 35: rpc.Commit
}
var file_repo_proto_depIdxs = []int32{
	3,  // 0: rpc.CreateRepositoryRequest.header:type_name -> rpc.CreateRepositoryRequestHeader
	31, // 1: rpc.CreateRepositoryRequest.file:type_name -> rpc.FileUpload
	32, // 2: rpc.CreateRepositoryRequestHeader.base:type_name -> rpc.WriteRequest
	33, // 3: rpc.CreateRepositoryRequestHeader.author:type_name -> rpc.Identity
	33, // 4: rpc.CreateRepositoryRequestHeader.committer:type_name -> rpc.Identity
	34, // 5: rpc.GetTreeNodeRequest.base:type_name -> rpc.ReadRequest
	9,  // 6: rpc.GetTreeNodeResponse.node:type_name -> rpc.TreeNode
	35, // 7: rpc.GetTreeNodeResponse.commit:type_name -> rpc.Commit
	34, // 8: rpc.ListTreeNodesRequest.base:type_name -> rpc.ReadRequest
	9,  // 9: rpc.ListTreeNodesResponse.node:type_name -> rpc.TreeNode
	35, // 10: rpc.ListTreeNodesResponse.commit:type_name -> rpc.Commit
	0,  // 11: rpc.TreeNode.type:type_name -> rpc.TreeNodeType
	1,  // 12: rpc.TreeNode.mode:type_name -> rpc.TreeNodeMode
	34, // 13: rpc.GetCommitRequest.base:type_name -> rpc.ReadRequest
	35, // 14: rpc.GetCommitResponse.commit:type_name -> rpc.Commit
	34, // 15: rpc.ListCommitsRequest.base:type_name -> rpc.ReadRequest
	35, // 16: rpc.ListCommitsResponse.commit:type_name -> rpc.Commit
	14, // 17: rpc.ListCommitsResponse.rename_details:type_name -> rpc.RenameDetails
	34, // 18: rpc.GetBlobRequest.base:type_name -> rpc.ReadRequest
	17, // 19: rpc.GetBlobResponse.header:type_name -> rpc.GetBlobResponseHeader
	34, // 20: rpc.GetSubmoduleRequest.base:type_name -> rpc.ReadRequest
	20, // 21: rpc.GetSubmoduleResponse.submodule:type_name -> rpc.Submodule
	34, // 22: rpc.GetCommitDivergencesRequest.base:type_name -> rpc.ReadRequest
	...
	32, // 25: rpc.DeleteRepositoryRequest.base:type_name -> rpc.WriteRequest
	32, // 26: rpc.SyncRepositoryRequest.base:type_name -> rpc.WriteRequest
	34, // 27: rpc.MergeBaseRequest.base:type_name -> rpc.ReadRequest
	2,  // 28: rpc.RepositoryService.CreateRepository:input_type -> rpc.CreateRepositoryRequest
	5,  // 29: rpc.RepositoryService.GetTreeNode:input_type -> rpc.GetTreeNodeRequest
	7,  // 30: rpc.RepositoryService.ListTreeNodes:input_type -> rpc.ListTreeNodesRequest
	18, // 31: rpc.RepositoryService.GetSubmodule:input_type -> rpc.GetSubmoduleRequest
	15, // 32: rpc.RepositoryService.GetBlob:input_type -> rpc.GetBlobRequest
	12, // 33: rpc.RepositoryService.ListCommits:input_type -> rpc.ListCommitsRequest
	10, // 34: rpc.RepositoryService.GetCommit:input_type -> rpc.GetCommitRequest
	21, // 35: rpc.RepositoryService.GetCommitDivergences:input_type -> rpc.GetCommitDivergencesRequest
	25, // 36: rpc.RepositoryService.DeleteRepository:input_type -> rpc.DeleteRepositoryRequest
	27, // 37: rpc.RepositoryService.SyncRepository:input_type -> rpc.SyncRepositoryRequest
	29, // 38: rpc.RepositoryService.MergeBase:input_type -> rpc.MergeBaseRequest
	4,  // 39: rpc.RepositoryService.CreateRepository:output_type -> rpc.CreateRepositoryResponse
	6,  // 40: rpc.RepositoryService.GetTreeNode:output_type -> rpc.GetTreeNodeResponse
	8,  // 41: rpc.RepositoryService.ListTreeNodes:output_type -> rpc.ListTreeNodesResponse
	19, // 42: rpc.RepositoryService.GetSubmodule:output_type -> rpc.GetSubmoduleResponse
	16, // 43: rpc.RepositoryService.GetBlob:output_type -> rpc.GetBlobResponse
	13, // 44: rpc.RepositoryService.ListCommits:output_type -> rpc.ListCommitsResponse
	11, // 45: rpc.RepositoryService.GetCommit:output_type -> rpc.GetCommitResponse
	23, // 46: rpc.RepositoryService.GetCommitDivergences:output_type -> rpc.GetCommitDivergencesResponse
	26, // 47: rpc.RepositoryService.DeleteRepository:output_type -> rpc.DeleteRepositoryResponse
	28, // 48: rpc.RepositoryService.SyncRepository:output_type -> rpc.SyncRepositoryResponse
	30, // 49: rpc.RepositoryService.MergeBase:output_type -> rpc.MergeBaseResponse
