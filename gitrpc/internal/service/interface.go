...
type GitAdapter interface {
	...
	ListCommits(ctx context.Context, repoPath string,
		ref string, afterRef string, page int, limit int, path string, since int64, until int64) ([]types.Commit, *types.PathRenameDetails, error)
	ListCommitSHAs(ctx context.Context, repoPath string,
		ref string, afterRef string, page int, limit int, path string, since int64, until int64) ([]string, error)
