...
import useRemoveQuarantineVersion from '@ar/pages/version-details/hooks/useRemoveQuarantineVersion'

import type { DigestActionProps } from './types'

function RemoveQurantineMenuItem(props: DigestActionProps) {
