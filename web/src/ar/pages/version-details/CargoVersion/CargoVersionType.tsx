...
import CargoVersionOverviewPage from './pages/overview/CargoVersionOverviewPage'
import { VersionDetailsTab } from '../components/VersionDetailsTabs/constants'
import ArtifactFilesContent from '../components/ArtifactFileListTable/ArtifactFilesContent'
import CargoVersionArtifactDetailsPage from './pages/artifact-dertails/CargoVersionArtifactDetailsPage'
...
export class CargoVersionType extends VersionStep<ArtifactVersionSummary> {
      ...
      case VersionDetailsTab.OVERVIEW:
        return (
          <VersionOverviewProvider>
            <CargoVersionOverviewPage />
          </VersionOverviewProvider>
        )
      case VersionDetailsTab.ARTIFACT_DETAILS:
        return (
          <VersionOverviewProvider>
            <CargoVersionArtifactDetailsPage />
          </VersionOverviewProvider>
        )
