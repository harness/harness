...
import CondaVersionArtifactDetailsPage from './pages/artifact-dertails/CondaVersionArtifactDetailsPage'
...
import CondaVersionOverviewPage from './pages/overview/CondaVersionOverviewPage'

export class CondaVersionType extends VersionStep<ArtifactVersionSummary> {
      ...
      case VersionDetailsTab.OVERVIEW:
        return (
          <VersionOverviewProvider>
            <CondaVersionOverviewPage />
          </VersionOverviewProvider>
        )
      case VersionDetailsTab.ARTIFACT_DETAILS:
        return (
          <VersionOverviewProvider>
            <CondaVersionArtifactDetailsPage />
          </VersionOverviewProvider>
        )
