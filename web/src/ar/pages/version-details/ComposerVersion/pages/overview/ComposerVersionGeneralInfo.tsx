...
interface ComposerVersionGeneralInfoProps {
  className?: string
}

export default function ComposerVersionGeneralInfo(props: ComposerVersionGeneralInfoProps) {
        ...
        <Layout.Horizontal
          ...
          <Container className={css.gridContainer}>
            <LabelValueContent
              ...
              value={getString('packageTypes.package', { name: getString('repositoryTypes.composer') })}
