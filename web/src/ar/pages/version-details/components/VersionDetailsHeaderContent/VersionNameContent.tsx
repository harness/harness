...
import VersionSelector from '@ar/pages/version-details/components/VersionSelector/VersionSelector'

interface VersionNameContentProps {
  name: string
  version: string
...
export default function VersionNameContent(props: VersionNameContentProps): JSX.Element {
