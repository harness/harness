...
import HuggingfaceVersionOverviewPage from './pages/overview/HuggingfaceVersionOverviewPage'
import { VersionDetailsTab } from '../components/VersionDetailsTabs/constants'
import ArtifactFilesContent from '../components/ArtifactFileListTable/ArtifactFilesContent'
import HuggingfaceVersionArtifactDetailsPage from './pages/artifact-dertails/HuggingfaceVersionArtifactDetailsPage'
...
export class HuggingfaceVersionType extends VersionStep<ArtifactVersionSummary> {
      ...
      case VersionDetailsTab.OVERVIEW:
        return (
          <VersionOverviewProvider>
            <HuggingfaceVersionOverviewPage />
          </VersionOverviewProvider>
        )
      case VersionDetailsTab.ARTIFACT_DETAILS:
        return (
          <VersionOverviewProvider>
            <HuggingfaceVersionArtifactDetailsPage />
          </VersionOverviewProvider>
        )
