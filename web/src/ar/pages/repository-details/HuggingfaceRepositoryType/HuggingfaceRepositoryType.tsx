...
export class HuggingfaceRepositoryType extends RepositoryStep<VirtualRegistryRequest> {
  protected packageType = RepositoryPackageType.HUGGINGFACE
  protected repositoryName = 'Huggingface Repository'
  ...
  supportedArtifactTypes: LocalArtifactType[] = [LocalArtifactType.DATASET, LocalArtifactType.MODEL]
  supportedRepositoryTabs = [
    RepositoryDetailsTab.DATASETS,
    RepositoryDetailsTab.MODELS,
    RepositoryDetailsTab.CONFIGURATION,
    RepositoryDetailsTab.WEBHOOKS
  ]

  protected defaultValues: VirtualRegistryRequest = {
    packageType: RepositoryPackageType.HUGGINGFACE,
    identifier: '',
    config: {
  ...
  protected defaultUpstreamProxyValues: UpstreamRegistryRequest = {
    ...
    config: {
      ...
      source: UpstreamRepositoryURLInputSource.HuggingFace,
  ...
  renderSetupClient(props: RepositoySetupClientProps): JSX.Element {
    return <SetupClientContent {...props} packageType={RepositoryPackageType.HUGGINGFACE} />
  }
