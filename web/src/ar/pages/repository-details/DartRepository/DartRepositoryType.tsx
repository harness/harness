...
export class DartRepositoryType extends RepositoryStep<VirtualRegistryRequest> {
  protected packageType = RepositoryPackageType.DART
  protected repositoryName = 'Dart Repository'
  protected repositoryIcon: IconName = 'dart-icon'
  ...
  protected defaultValues: VirtualRegistryRequest = {
    packageType: RepositoryPackageType.DART,
    identifier: '',
    config: {
  ...
  protected defaultUpstreamProxyValues: UpstreamRegistryRequest = {
    ...
    config: {
      ...
      source: UpstreamRepositoryURLInputSource.Pubdev,
  ...
  renderSetupClient(props: RepositoySetupClientProps): JSX.Element {
    return <SetupClientContent {...props} packageType={RepositoryPackageType.DART} />
  }
