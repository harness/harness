...
export class GoRepositoryType extends RepositoryStep<VirtualRegistryRequest> {
  protected packageType = RepositoryPackageType.GO
  protected repositoryName = 'Go Repository'
  ...
  protected defaultValues: VirtualRegistryRequest = {
    packageType: RepositoryPackageType.GO,
    identifier: '',
    config: {
  ...
  protected defaultUpstreamProxyValues: UpstreamRegistryRequest = {
    ...
    config: {
      ...
      source: UpstreamRepositoryURLInputSource.GoProxy,
  ...
  renderSetupClient(props: RepositoySetupClientProps): JSX.Element {
    return <SetupClientContent {...props} packageType={RepositoryPackageType.GO} />
  }
