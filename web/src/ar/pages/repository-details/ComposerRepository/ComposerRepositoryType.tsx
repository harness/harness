...
export class ComposerRepositoryType extends RepositoryStep<VirtualRegistryRequest> {
  protected packageType = RepositoryPackageType.COMPOSER
  protected repositoryName = 'Composer Repository'
  protected repositoryIcon: IconName = 'php-composer-logo'
  ...
  protected defaultValues: VirtualRegistryRequest = {
    packageType: RepositoryPackageType.COMPOSER,
    identifier: '',
    config: {
  ...
  protected defaultUpstreamProxyValues: UpstreamRegistryRequest = {
    ...
    config: {
      ...
      source: UpstreamRepositoryURLInputSource.Packagist,
  ...
  renderSetupClient(props: RepositoySetupClientProps): JSX.Element {
    return <SetupClientContent {...props} packageType={RepositoryPackageType.COMPOSER} />
  }
