CREATE TABLE registry_tasks (
    ...
    registry_task_payload     text,
    registry_task_status      text NOT NULL DEFAULT 'pending',
...
CREATE TABLE registry_task_sources (
    ...
    registry_task_source_status     task_status NOT NULL DEFAULT 'pending',
...
CREATE TABLE registry_task_events (
    ...
    registry_task_event_payload            text,
