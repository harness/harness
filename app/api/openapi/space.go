...
func spaceOperations(reflector *openapi3.Reflector) {
	...
	_ = reflector.SetJSONResponse(&opCreate, new(space.Space), http.StatusCreated)
	...
	_ = reflector.SetJSONResponse(&opImport, new(space.Space), http.StatusCreated)
	...
	_ = reflector.SetJSONResponse(&opGet, new(space.Space), http.StatusOK)
	...
	_ = reflector.SetJSONResponse(&opUpdate, new(space.Space), http.StatusOK)
	...
	_ = reflector.SetJSONResponse(&opRestore, new(space.Space), http.StatusOK)
	...
	_ = reflector.SetJSONResponse(&opMove, new(space.Space), http.StatusOK)
	...
	_ = reflector.SetJSONResponse(&opSpaces, []space.Space{}, http.StatusOK)
