...
func (c *Controller) AutolinkCreate(
	ctx context.Context,
	session *auth.Session,
	spaceRef string,
	in *autolink.AutoLinkInput,
	...
	autolink, err := c.autolinkSvc.Create(ctx, session.Principal.ID, autolink.Scope{SpaceID: &space.ID}, in)
	if err != nil {
