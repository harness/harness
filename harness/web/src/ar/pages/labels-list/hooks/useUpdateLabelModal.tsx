...
import UpdateLabelForm from '../components/LabelForm/UpdateLabelForm'

import css from './styles.module.scss'

export interface useUpdateLabelModalProps {
  onSuccess: (response: TypesLabelWithValues) => void
  data: TypesLabel
}

export function useUpdateLabelModal(props: useUpdateLabelModalProps) {
      ...
      <ModalDialog
        ...
        title={
          <Text font={{ variation: FontVariation.H3 }} margin={{ bottom: 'small' }}>
            {getString('labelsList.updateLabelModal.title')}
          </Text>
        }
        isCloseButtonShown
        width={900}
        ...
        footer={
          <Layout.Horizontal spacing="small">
            <Button
              ...
              type={'submit'}
              text={getString('labelsList.updateLabelModal.actions.update')}
              data-id="label-save"
            ...
            <Button
              ...
              text={getString('labelsList.updateLabelModal.actions.cancel')}
              onClick={hideModal}
            />
          </Layout.Horizontal>
        }>
