...
import { mockMavenArtifactDetails, mockMavenVersionList, mockMavenVersionSummary } from './__mockData__'
...
describe('Verify maven version overview page', () => {
  beforeAll(() => {
    jest.clearAllMocks()
  })
  ...
  test('should render overview content without error', async () => {
    ...
    const data = mockMavenArtifactDetails.data as ArtifactDetail & MavenArtifactDetailConfig
    ...
    expect(generalInformationCard).toHaveTextContent(
      'versionDetails.overview.generalInformation.packageType' + 'packageTypes.mavenPackage'
    )
    expect(generalInformationCard).toHaveTextContent(
    ...
    expect(generalInformationCard).toHaveTextContent(
      'versionDetails.overview.generalInformation.downloads' + data.downloadCount
    )
  })
