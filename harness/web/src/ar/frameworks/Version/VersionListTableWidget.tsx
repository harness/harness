...
import type { VersionListTableProps } from './Version'
import type { VersionAbstractFactory } from './VersionAbstractFactory'

interface VersionListTableWidgetProps extends VersionListTableProps {
  factory?: VersionAbstractFactory
  packageType: RepositoryPackageType
}

export default function VersionListTableWidget(props: VersionListTableWidgetProps): JSX.Element {
  ...
  return repositoryType.renderVersionListTable({ ...rest })
}
