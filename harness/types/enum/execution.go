...
// ExecutionSort enumeration.
const (
	ExecutionSortStarted  = "started"
	ExecutionSortFinished = "finished"
)

var executionSorts = sortEnum([]ExecutionSort{
	ExecutionSortStarted,
	ExecutionSortFinished,
})
