...
func TestGetAllRegistryResponse(t *testing.T) {
	...
	response := controller.GetAllRegistryResponse(context.Background(), &registries, 1, 1, 10, "root", mockURLProvider)
...
func TestGetRegistryMetadata(t *testing.T) {
	...
	metadata := controller.GetRegistryMetadata(context.Background(), &registries, "root", mockURLProvider)
